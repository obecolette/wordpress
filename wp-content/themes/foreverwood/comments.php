...
<div id="comments" class="comments-area<?php if ( get_theme_mod('foreverwood_next_preview_post', $foreverwood_defaults['foreverwood_next_preview_post']) == 'Display' || get_theme_mod('foreverwood_next_preview_post', $foreverwood_defaults['foreverwood_next_preview_post']) == '' ) { ?> comments-area-post<?php } ?>">
