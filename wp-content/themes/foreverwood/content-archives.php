...
<?php if ( get_theme_mod('foreverwood_display_meta_post_entry', $foreverwood_defaults['foreverwood_display_meta_post_entry']) != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php } ?>
        <div class="post-entry-content"><?php if ( get_theme_mod('foreverwood_content_archives', $foreverwood_defaults['foreverwood_content_archives']) != 'Content' ) { ?><?php the_excerpt(); ?><?php } else { ?><?php global $more; $more = 0; ?><?php the_content(); ?><?php } ?></div>
    </article>