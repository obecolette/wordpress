...
<?php if ( get_theme_mod('foreverwood_display_meta_post', $foreverwood_defaults['foreverwood_display_meta_post']) != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php endwhile; endif; ?>
<?php if ( get_theme_mod('foreverwood_next_preview_post', $foreverwood_defaults['foreverwood_next_preview_post']) != 'Hide' ) { ?>
<?php foreverwood_prev_next('foreverwood-post-nav'); ?>
<?php } ?> 
<?php comments_template( '', true ); ?>
    </article> <!-- end of content -->
  </div>
<?php if (get_theme_mod('foreverwood_display_sidebar', $foreverwood_defaults['foreverwood_display_sidebar']) != 'Hide') { ?>
<?php get_sidebar(); ?>
<?php } ?>
  </div>
